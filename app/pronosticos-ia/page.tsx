...
export default function PronosticosIAHubPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <section className="rounded-2xl bg-gradient-to-br from-emerald-900 via-emerald-700 to-lime-600 text-white p-8 md:p-10 shadow-xl">
        ...
        <p className="mt-4 text-emerald-50 max-w-3xl leading-relaxed">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            href="/pronosticos-ia/hoy"
            className="inline-flex items-center rounded-xl bg-white text-emerald-800 px-5 py-2.5 font-semibold hover:bg-emerald-50 transition-colors"
          >
            Ver picks de hoy
          </Link>
          <Link
            href="/predicciones"
            className="inline-flex items-center rounded-xl border border-white/70 px-5 py-2.5 font-semibold hover:bg-white/10 transition-colors"
          >
      ...
      <section className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
        {pillars.map((item) => (
          <Link key={item.title} href={item.href}>
            <article className="h-full rounded-2xl border border-gray-200 bg-white p-6 hover:shadow-lg hover:border-emerald-400 transition-all">
              ...
              <p className="mt-4 text-emerald-700 font-semibold">Entrar →</p>
            </article>
          </Link>
        ))}
      </section>
